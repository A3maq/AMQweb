...
class es_cls_registerhook {
	...
	public static function es_load_widget_scripts_styles() {
		...
		$es_select_params = array(
			'es_email_notice'       => _x( 'الرجاء إدخال عنوان البريد الإلكتروني', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_incorrect_email'    => _x( 'عنوان البريد الإلكتروني هذا غير صالح', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_load_more'          => _x( 'جاري التحميل...', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_ajax_error'         => _x( 'Cannot create XMLHTTP instance', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_success_message'    => _x( 'تم إرسال طلب الاشتراك بنجاح.', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_success_notice'     => _x( 'في غضون بضع دقائق، يرجى مراجعة البريد في صندوق البريد الخاص بك وتأكيد اشتراكك. إذا لم تتمكن من رؤية البريد في صندوق البريد الخاص بك، يرجى التحقق من مجلد الرسائل غير المرغوب فيها.', 'widget-enhanced-select', ES_TDOMAIN ),
			'es_email_exists'       => _x( 'البريد الالكتروني مسجل مسبقاً', 'widget-enhanced-select', ES_TDOMAIN ),
		...
		$es_select_params = array(
			'es_email_notice'       => _x( 'الرجاء إدخال عنوان البريد الإلكتروني', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_incorrect_email'    => _x( 'عنوان البريد الإلكتروني هذا غير صالح', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_load_more'          => _x( 'جاري التحميل...', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_ajax_error'         => _x( 'Cannot create XMLHTTP instance', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_success_message'    => _x( 'تم إرسال طلب الاشتراك بنجاح.', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_success_notice'     => _x( 'في غضون بضع دقائق، يرجى مراجعة البريد في صندوق البريد الخاص بك وتأكيد اشتراكك. إذا لم تتمكن من رؤية البريد في صندوق البريد الخاص بك، يرجى التحقق من مجلد الرسائل غير المرغوب فيها.', 'widget-page-enhanced-select', ES_TDOMAIN ),
			'es_email_exists'       => _x( 'البريد الالكتروني مسجل مسبق', 'widget-page-enhanced-select', ES_TDOMAIN ),
	...
	function widget( $args, $instance ) {
		...
		<div>
			<form class="es_widget_form" data-es_form_id="es_widget_form">
				...
				<?php } ?>
				<div class="es_lablebox"><label class="es_widget_form_email"><?php echo __( 'البريد الإلكتروني', ES_TDOMAIN ); ?></label></div>
				<div class="es_textbox">
				...
				<div class="es_button">
					<input type="button" id="es_txt_button" class="es_textbox_button es_submit_button" name="es_txt_button" onClick="return es_submit_page(event,'<?php echo $url; ?>')" value="اشتراك">
				</div>
